...
//    logger.error(ex);
//    return handleExceptionInternal(
//        ex, "Internal server error", new HttpHeaders(), HttpStatus.INTERNAL_SERVER_ERROR, request);
//  }
  ...
  @ExceptionHandler(value = PassNotFoundException.class)
  public ResponseEntity<Object> PassNotFoundException(Exception ex, WebRequest webRequest) {
    log.info("======NotFoundException====: ");
    return handleExceptionInternal(
        ex, "Mật khẩu sai rồi b ê", new HttpHeaders(), HttpStatus.BAD_REQUEST, webRequest);
  }

  @ExceptionHandler(value = TokenNotFoundException.class)
  public ResponseEntity<Object> TokenNotFoundException(Exception ex, WebRequest webRequest) {
    log.info("======NotFoundException====: ");
    return handleExceptionInternal(
        ex, ex.getMessage(), new HttpHeaders(), HttpStatus.BAD_REQUEST, webRequest);
  }
